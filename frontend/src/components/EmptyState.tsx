 ...
 * избранное, пустая очередь. Композиция та же, что у StatusPage: иконка в круге, заголовок,
 * пояснение, действие — по центру. Серый прямоугольник с одной строкой по левому краю читался
 * бы как заглушка, а не как часть продукта.
 *

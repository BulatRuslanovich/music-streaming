...
public static class Explorer
{
        ...
        int seed)
    {
        ...
        // Пул, который исчерпался, отдаёт свои слоты другому: у слушателя без истории нет ничего
        // знакомого, а у того, кто прослушал всё, — ничего нового. Ни тому, ни другому не следует
        // подавать полупустую полку, поэтому исследование забирает то, что не смогла заполнить
        // эксплуатация.
        var exploreSlots = Math.Min(count - exploitSlots, novel.Count);

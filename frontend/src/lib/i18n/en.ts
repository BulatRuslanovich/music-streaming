...
export const en = {
  ...
  "dj.mode.ForYou.hint": "A dependable mix shaped by your listening.",
  "dj.mode.Rediscover": "Forgotten favourites",
  "dj.mode.Rediscover.hint": "Good music you have not played in a while.",
  "dj.mode.Discover": "Discovery",
  "dj.mode.Discover.hint": "Unheard tracks from your own library.",
  "dj.mode.Flow": "Keep the mood",
  "dj.mode.Flow.hint": "Follow the sound of the current or latest track.",

...
# Модель принимает ровно 10 секунд. musik нарезал по 30 с, но ClapFeatureExtractor в режиме
# rand_trunc всё равно обрезал каждое окно до СЛУЧАЙНЫХ 10 с несеянным RNG — то есть повторный
# эмбеддинг того же файла давал другой вектор. Берём 10 с явно: детерминированно и втрое
# дешевле по декодированию.
WINDOW_SECONDS = 10.0

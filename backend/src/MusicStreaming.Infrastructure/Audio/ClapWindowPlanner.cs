...
/// <para>
/// Окно длиннее десяти секунд отдавать бессмысленно: <c>ClapFeatureExtractor</c> в режиме
/// <c>rand_trunc</c> обрежет его до <b>случайных</b> десяти несеянным генератором, и повторный
/// эмбеддинг того же файла даст другой вектор. Явные десять секунд детерминированы.
/// </para>
/// </summary>

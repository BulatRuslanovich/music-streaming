 ...
 *
 * Не скруглённая коробка с градиентом внутри: такая читается как виджет, лежащий на тёмной
 * странице, а не как шапка самой страницы. Отсюда три решения:
 *
 ...
 * 2. Арт крупнее и получает `--elevation-hero`: на 208px тень `0 4px 12px / 30%`
 *    не видна вовсе, и обложка выглядит наклеенной.

    ...
    >
      <div className="modal easter-egg" role="dialog" aria-modal="true" aria-label="Секрет">
        ...
        <p className="easter-egg-text">
          ...
          оно предназначалось для ника самого младшего.
        </p>

        <p className="easter-egg-text">
          <strong>Caimack</strong> — не больше и не меньше. 
          Никакого глубокого смысла за названием нет.
          Надеюсь, он придумает себе ник получше, чем

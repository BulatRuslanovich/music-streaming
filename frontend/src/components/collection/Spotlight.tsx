...
/**
 * Тинтованная панель «первого экрана»: слева арт с кнопками, справа превью очереди. Тинт приходит
 * готовым цветом, а не обложкой — вызывающая сторона сама решает, от чего его считать, и не даёт
 * фону перекрашиваться на каждой смене трека.
 */

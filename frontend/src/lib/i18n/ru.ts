...
export const ru: Dictionary = {
  ...
  "dj.mode.ForYou.hint": "Надёжная смесь на основе ваших прослушиваний.",
  "dj.mode.Rediscover": "Забытое любимое",
  "dj.mode.Rediscover.hint": "Хорошая музыка, которую вы давно не включали.",
  "dj.mode.Discover": "Открытия",
  "dj.mode.Discover.hint": "Ещё не прослушанные треки из вашей библиотеки.",
  "dj.mode.Flow": "Продолжить настроение",
  "dj.mode.Flow.hint": "Развить звучание текущего или последнего трека.",

...
export const en = {
  ...
  "sound.duration": "{seconds} seconds",
  "sound.transitionHint":
    "Transitions prepare whole tracks and use extra memory and traffic. They work when preparation finishes in time. Data saver, slow connections, offline playback and long recordings use ordinary streaming.",

  "connect.title": "Caimack Connect",
  "connect.hint": "Control music on your open devices. Keep Caimack open on the playback device.",
  "connect.failed": "The command could not be completed. Check the playback device.",
  "connect.thisDevice": "This device",
  "connect.unavailable": "Connecting to your devices…",
  "connect.seconds": "s",
  "connect.volume": "Volume",
  "connect.continueHere": "Continue here",
  "connect.playThere": "Transfer here",

  "recap.title": "Monthly recap",
  "recap.subtitle": "Your month in music, for the first week of the new one.",
  ...
  "recap.discoveries": "New to your listening history",
  "recap.discoveryHint": "First heard this month, according to your saved listening history.",
  "recap.versusPrevious": "vs the month before",
  "recap.statTracks": "Tracks",
  "recap.statArtists": "Artists",
  "recap.statGenre": "Genre",
  "recap.statDiscoveries": "Discoveries",
  "recap.genreShift": "Your main genre moved from {from} to {to}.",
  "recap.playlistName": "My music — {month}",
  "recap.failed": "Could not save the recap. Please try again.",
  "recap.listen": "Listen to this month",
  "recap.savePlaylist": "Save playlist",
  "recap.saveImage": "Save image",
  "recap.bannerBody": "Your {month} is ready",
  "recap.dismiss": "Hide the monthly recap",
  "recap.watchStory": "Watch the story",
  "recap.storyStep": "{current} of {total}",
  "recap.storyClose": "Close the story",
  "recap.storyNext": "Next slide",
  "recap.storyPrevious": "Previous slide",
  "recap.storyProgress": "Story progress",
  "recap.storyDetails": "See the details",
  "recap.slide.introNote": "Here is what last month sounded like.",
  "recap.slide.timeLabel": "You listened for",
  "recap.slide.timeUp": "{percent}% more than the month before.",
  "recap.slide.timeDown": "{percent}% less than the month before.",
  "recap.slide.topTrackLabel": "The one you kept coming back to",
  "recap.slide.topArtistLabel": "Your artist of the month",
  "recap.slide.genreLabel": "Your sound",
  "recap.slide.genreSteady": "The same one you were on last month.",
  "recap.slide.finaleLabel": "That was your month",
  ...
  "menu.offlineDownload": "Download for offline listening",
  "menu.offlineDownloading": "Downloading for offline…",
  "menu.offlineRemove": "Remove offline download",
  "menu.offlineReady": "Track is ready for offline listening.",
  "menu.offlineRemoved": "Offline download removed.",
  "menu.offlineFailed": "Could not save the track for offline listening.",
  "offline.collectionDownload": "Download offline",
  "offline.collectionDownloading": "Downloading…",
  "offline.collectionReadyLabel": "Downloaded",
  "offline.collectionReady": "Collection is ready for offline listening.",
  ...
  "admin.nav.listeners": "Listeners",
  "admin.nav.uploads": "Uploads",
  "admin.nav.label": "Administration",

  "admin.stats.title": "Service statistics",
  "admin.stats.subtitle": "What is happening across the whole library.",
  "admin.stats.empty": "Nothing has been listened to in this period yet.",

  "admin.stats.people": "People",
  "admin.stats.totalUsers": "Accounts",
  "admin.stats.activeUsers": "Active",
  "admin.stats.activeUsersHint": "Listened to something during the period.",
  "admin.stats.newUsers": "New",

  "admin.stats.library": "Library",
  "admin.stats.totalTracks": "Tracks",
  "admin.stats.addedTracks": "Added",
  "admin.stats.totalSize": "Size on disk",
  "admin.stats.totalDuration": "Total length",

  "admin.stats.listening": "Listening",
  "admin.stats.listenedTime": "Listening time",
  "admin.stats.plays": "Plays",
  "admin.stats.listeners": "Listeners",
  "admin.stats.tracksHeard": "Tracks heard",
  "admin.stats.completed": "Finished",
  "admin.stats.skipped": "Skipped",
  "admin.stats.skipRate": "Skip rate",
  ...
  "admin.stats.withoutLyrics": "No lyrics",
  "admin.stats.withoutGenre": "No genre",
  "admin.stats.withoutAlbum": "No album",
  "admin.stats.withoutYear": "No year",
  "admin.stats.neverListened": "Never played",
  "admin.stats.highSkipRate": "Often skipped",
  "admin.stats.highSkipRateHint":
    "Skipped more than {percent}% of the time, over at least {events} finished plays.",

  "admin.stats.topListeners": "Most listening time",
  "admin.stats.topUploaders": "Most tracks added",

  "admin.stats.listenersTitle": "Listeners",
  "admin.stats.listenersSubtitle": "Every account and what it did during the period.",
  "admin.stats.searchListeners": "Filter by name",
  "admin.stats.listenersEmpty": "No accounts match that.",
  "admin.stats.lastActive": "Last active",
  "admin.stats.neverActive": "Never",
  "admin.stats.uploadedTracks": "Added",
  "admin.stats.uploadedBytes": "Upload size",
  ...
  "admin.stats.uploadsTitle": "Uploads",
  "admin.stats.uploadsSubtitle": "Every track in the library and where it came from.",
  ...
  "admin.stats.sort.LastActiveAt": "Last active",
  "admin.stats.sort.ListenedSeconds": "Listening time",
  "admin.stats.sort.Plays": "Plays",
  "admin.stats.sort.UploadedTracks": "Tracks added",
  "admin.stats.sort.UploadedBytes": "Upload size",
  "admin.stats.sort.SkipRate": "Skip rate",
  "admin.stats.sort.FileSize": "File size",
  ...
  "settings.offline": "Offline downloads",
  "settings.offlineHint": "Tracks saved here remain playable when this device has no connection.",
  "settings.offlineUnavailable": "Offline downloads require HLS to be enabled on the server.",
  "settings.offlineEmpty": "Use a track menu to save music for offline listening.",
  "settings.offlineUsage": { one: "{count} track · {size}", other: "{count} tracks · {size}" },
  "settings.offlineRemoveAll": "Remove all",
  "settings.offlineRemoveNamed": "Remove the offline copy of {title}",
  "settings.offlineState.preparing": "preparing",
  "settings.offlineState.downloading": "downloading",
  "settings.offlineState.ready": "ready offline",
  "settings.offlineState.failed": "download failed",

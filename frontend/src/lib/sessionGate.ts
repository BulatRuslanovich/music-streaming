...
/**
 * Пускать ли к странице — решение middleware, вынесенное сюда целиком.
 *
 ...
 * попадал в петлю: клиент ловил 401, уходил на /login, middleware видел подсказку и заворачивал

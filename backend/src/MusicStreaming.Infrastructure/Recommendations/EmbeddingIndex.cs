...
/// новый снимок в фоне и подменяет ссылку целиком. musik вместо этого берёт RWMutex вокруг
/// каждого скалярного произведения — здесь так делать не нужно и не нужно повторять.
/// </para>
/// </summary>

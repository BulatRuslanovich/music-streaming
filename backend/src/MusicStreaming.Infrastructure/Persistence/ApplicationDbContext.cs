    ...
    : DbContext(options), IApplicationDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        // Результаты агрегаций статистики: своей таблицы у них нет и быть не должно, они существуют
        // только как форма ответа сырого запроса, которому нужен AT TIME ZONE. Отсюда и исключение
        // из миграций — иначе EF завёл бы под них настоящие таблицы, в которые никто ничего не пишет.

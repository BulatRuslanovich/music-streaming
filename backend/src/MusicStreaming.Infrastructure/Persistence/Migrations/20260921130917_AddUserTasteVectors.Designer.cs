...
namespace MusicStreaming.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260921130917_AddUserTasteVectors")]
    partial class AddUserTasteVectors
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MusicStreaming.Application.Services.Admin.AdminListenerRow", b =>
                {
                    ...
                    b.Property<int>("UploadedTracks")
                        .HasColumnType("integer")
                        .HasColumnName("uploaded_tracks");
                    ...
                    b.ToTable("admin_listener_row", null, t =>
                        {
                            t.ExcludeFromMigrations();
                        });
                });

            modelBuilder.Entity("MusicStreaming.Application.Services.Admin.DailyUploadRow", b =>
                {
                    ...
                    b.ToTable("daily_upload_row", null, t =>
                        {
                            t.ExcludeFromMigrations();
                        });
                });
            ...
            modelBuilder.Entity("MusicStreaming.Application.Services.TagRow", b =>
                {
                    b.Property<Guid?>("AlbumId")
                        .HasColumnType("uuid")
                        .HasColumnName("album_id");
            ...
            modelBuilder.Entity("MusicStreaming.Domain.Entities.Recommendations.TrackEmbedding", b =>
                {
                    b.Property<Guid>("TrackId")
                        .HasColumnType("uuid")
                        .HasColumnName("track_id");
                    ...
                    b.HasKey("TrackId")
                        .HasName("pk_track_embeddings");

                    b.HasIndex("AnalyzedAt")
                        .HasDatabaseName("ix_track_embeddings_analyzed_at");

                    b.HasIndex("ClusterId")
                        .HasDatabaseName("ix_track_embeddings_cluster_id");

                    b.HasIndex("Succeeded", "ModelId", "Strategy")
                        .HasDatabaseName("ix_track_embeddings_succeeded_model_id_strategy");

                    b.ToTable("track_embeddings", (string)null);
                });
            ...
            modelBuilder.Entity("MusicStreaming.Domain.Entities.Recommendations.TrackStats", b =>
                {
                    ...
                    b.Property<int>("SkippedEarlyCount")
                        .HasColumnType("integer")
                        .HasColumnName("skipped_early_count");
            ...
            modelBuilder.Entity("MusicStreaming.Domain.Entities.Recommendations.UserTasteVector", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uuid")
                        .HasColumnName("user_id");
                    ...
                    b.HasKey("UserId", "Context")
                        .HasName("pk_user_taste_vectors");

                    b.ToTable("user_taste_vectors", (string)null);
                });
            ...
            modelBuilder.Entity("MusicStreaming.Domain.Entities.Track", b =>
                {
                    ...
                    b.Property<int>("IngestionSource")
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("AddedByUserId", "CreatedAt")
                        .HasDatabaseName("ix_tracks_added_by_user_id_created_at");
            ...
            modelBuilder.Entity("MusicStreaming.Domain.Entities.Recommendations.TrackEmbedding", b =>
                {
                    b.HasOne("MusicStreaming.Domain.Entities.Track", "Track")
                        .WithOne("Embedding")
                        .HasForeignKey("MusicStreaming.Domain.Entities.Recommendations.TrackEmbedding", "TrackId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_track_embeddings_tracks_track_id");
            ...
            modelBuilder.Entity("MusicStreaming.Domain.Entities.Recommendations.UserTasteVector", b =>
                {
                    b.HasOne("MusicStreaming.Domain.Entities.User", "User")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_user_taste_vectors_users_user_id");
            ...
            modelBuilder.Entity("MusicStreaming.Domain.Entities.Track", b =>
                {
                    b.HasOne("MusicStreaming.Domain.Entities.User", "AddedByUser")
                        .WithMany()
                        .HasForeignKey("AddedByUserId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_tracks_users_added_by_user_id");

...
namespace MusicStreaming.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260821143443_AddAudioFeatures")]
    partial class AddAudioFeatures
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MusicStreaming.Application.Services.Recommendations.DiagnosticsTotalsRow", b =>
                {
                    b.Property<int>("AffinityRows")
                        .HasColumnType("integer")
                        .HasColumnName("affinity_rows");

                    b.Property<int>("CachedShelves")
                        .HasColumnType("integer")
                        .HasColumnName("cached_shelves");

                    b.Property<int>("Clicks")
                        .HasColumnType("integer")
                        .HasColumnName("clicks");

                    b.Property<long>("EventsStored")
                        .HasColumnType("bigint")
                        .HasColumnName("events_stored");

                    b.Property<int>("Impressions")
                        .HasColumnType("integer")
                        .HasColumnName("impressions");

                    b.Property<DateTimeOffset?>("NewestEvent")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("newest_event");

                    b.Property<int>("ProfiledUsers")
                        .HasColumnType("integer")
                        .HasColumnName("profiled_users");

                    b.Property<int>("SimilarityRows")
                        .HasColumnType("integer")
                        .HasColumnName("similarity_rows");

                    b.Property<int>("StaleShelves")
                        .HasColumnType("integer")
                        .HasColumnName("stale_shelves");

                    b.Property<int>("TracksWithNeighbours")
                        .HasColumnType("integer")
                        .HasColumnName("tracks_with_neighbours");

                    b.ToTable("diagnostics_totals_row", null, t =>
                        {
                            t.ExcludeFromMigrations();
                        });
                });

            modelBuilder.Entity("MusicStreaming.Application.Services.Recommendations.ShelfSizeRow", b =>
                {
                    b.Property<double>("AverageItems")
                        .HasColumnType("double precision")
                        .HasColumnName("average_items");
                    ...
                    b.ToTable("shelf_size_row", null, t =>
                        {
                            t.ExcludeFromMigrations();
                        });
                });

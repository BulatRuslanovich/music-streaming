...
/**
 * Зона загрузки — первый экран этой страницы, поэтому она построена как лид-блок главной:
 * тинтованная панель со скруглением 2xl, а не тонкая пунктирная рамка. Пунктир остаётся, но
 * только как подсказка «сюда можно бросить», и на перетаскивании вся панель уходит в primary.
 *
 * Ни форматов, ни лимита здесь нет: и то и другое уже сказано в подзаголовке страницы, а
 * повторять одно и то же на одном экране незачем.
 */

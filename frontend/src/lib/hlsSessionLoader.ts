...
// Проба готовности уже скачивает master.m3u8 целиком; выброси его — и hls.js запросит ровно
// тот же URL второй раз. Здесь текст лежит до первого обращения загрузчика.

...
export const ru: Dictionary = {
  ...
  "recap.subtitle": "Твой месяц в музыке — первую неделю нового.",
  ...
  "recap.versusPrevious": "к предыдущему месяцу",
  "recap.statTracks": "Треков",
  "recap.statArtists": "Исполнителей",
  "recap.statGenre": "Жанр",
  "recap.statDiscoveries": "Открытий",
  "recap.genreShift": "Главный жанр сменился с {from} на {to}.",
  ...
  "recap.bannerBody": "Твой {month} готов",
  "recap.dismiss": "Скрыть итоги месяца",
  "recap.watchStory": "Смотреть историю",
  "recap.storyStep": "{current} из {total}",
  "recap.storyClose": "Закрыть историю",
  "recap.storyNext": "Следующий слайд",
  "recap.storyPrevious": "Предыдущий слайд",
  "recap.storyProgress": "Ход истории",
  "recap.storyDetails": "Смотреть подробности",
  "recap.slide.introNote": "Вот как звучал твой прошлый месяц.",
  "recap.slide.timeLabel": "Ты слушал",
  "recap.slide.timeUp": "На {percent}% больше, чем месяцем раньше.",
  "recap.slide.timeDown": "На {percent}% меньше, чем месяцем раньше.",
  "recap.slide.topTrackLabel": "К нему ты возвращался чаще всего",
  "recap.slide.topArtistLabel": "Исполнитель твоего месяца",
  "recap.slide.genreLabel": "Твоё звучание",
  "recap.slide.genreSteady": "То же, что и месяцем раньше.",
  "recap.slide.finaleLabel": "Таким был твой месяц",

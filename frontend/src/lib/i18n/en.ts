...
export const en = {
  ...
  "recap.subtitle": "Your month in music.",
  "recap.month": "Month",
  "recap.empty": "A quiet month",
  "recap.emptyHint": "Choose another month or come back after listening.",
  "recap.minutes": "{count} minutes of music",
  "recap.artists": "{count} artists",
  "recap.artistNamed": "Artist: {name}",
  "recap.trackNamed": "Track: {name}",
  "recap.genreNamed": "Genre: {name}",
  "recap.yourMonth": "Your soundtrack",
  "recap.breadth": "{tracks} tracks · {artists} artists",
  "recap.topArtist": "Your main artist",
  ...
  "recap.comparison": "Compared with last month",
  "recap.changeHint": "Change in listening time compared with the previous calendar month.",
  "recap.keep": "Keep this month",
  "recap.playlistName": "My music — {month}",
  "recap.failed": "Could not save the recap. Please try again.",
  "recap.inProgress": "This month is still in progress. The recap will keep changing.",
  "recap.pages": "Recap pages",
  "recap.back": "Back",
  "recap.next": "Next",
